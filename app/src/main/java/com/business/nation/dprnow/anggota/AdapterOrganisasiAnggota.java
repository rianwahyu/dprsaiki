...
public class AdapterOrganisasiAnggota extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    ViewHolders viewHolder;

    private List<ModelOrganisasiAnggota> mDataset;


    public AdapterOrganisasiAnggota(Context context, List<ModelOrganisasiAnggota> myDataset) {
