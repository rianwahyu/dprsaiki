...
public class NaskahActivity extends AppCompatActivity implements ItemClickListener, EasyPermissions.PermissionCallbacks {

    RecyclerView recyclerView;
    private List<ModelNaskahAkademik> listNaskah = new ArrayList<ModelNaskahAkademik>();
    AdapterNaskah2 adapterNaskah;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(NaskahActivity.this);
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        listNaskah = new ArrayList<ModelNaskahAkademik>();
        recyclerView = findViewById(R.id.rcNaskah);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapterNaskah = new AdapterNaskah2(NaskahActivity.this, listNaskah);
        recyclerView.setAdapter(adapterNaskah);
        initAnggota();
        adapterNaskah.setClickListener(this);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        String urlPDF= NetworkState.getUrlPDF()+"/naskah/"+FILE_PDF;
    ...
    public void onClick(View view, int position) {
        ModelNaskahAkademik mna = listNaskah.get(position);

        String id = mna.getID();
        urlFILES = mna.getFILE_PDF();

        if (CheckForSDCard.isSDCardPresent()) {
            if (EasyPermissions.hasPermissions(NaskahActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                //Get the URL entered
                ...
                EasyPermissions.requestPermissions(NaskahActivity.this, getString(R.string.write_file), WRITE_REQUEST_CODE, Manifest.permission.READ_EXTERNAL_STORAGE);
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, NaskahActivity.this);
    ...
    private class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.progressDialog = new ProgressDialog(NaskahActivity.this);
