...
public class AdapterPendidikanAnggota extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    ViewHolders viewHolder;

    private List<ModelPendidikanAnggota> mDataset;


    public AdapterPendidikanAnggota(Context context, List<ModelPendidikanAnggota> myDataset) {
