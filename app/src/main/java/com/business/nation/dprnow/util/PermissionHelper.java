...
public class PermissionHelper {
    ...
    public void onRequsetCallBack(int RequestCode, String[] permissions , int[] grantResults){
        switch (RequestCode) {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (perms.get(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(mActivity, Manifest.permission.CAMERA) ||
                            ...
                            showDialogOK("Accessing Location Permissions required",
...
//                                                    break;
                        ...
                        // shouldShowRequestPermissionRationale will return false
                            ...
                            Toast.makeText(mActivity, "Go to App settings and enable permissions", Toast.LENGTH_LONG).show();
