...
import com.business.nation.dprnow.regulasi.ModelRegulasi;

import java.util.List;

public class AdapterNaskah2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    ViewHolders viewHolder;

    private List<ModelNaskahAkademik> mDataset;
    private ItemClickListener itemClickListener;


    public AdapterNaskah2(Context context, List<ModelNaskahAkademik> myDataset) {
